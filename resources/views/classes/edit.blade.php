...
<div class="mx-auto max-w-3xl space-y-6">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
            ...
            <p class="mt-2 text-sm text-gray-500">Mettez a jour les informations de <span class="font-medium text-gray-700">{{ $classe->nom_classe }}</span>.</p>
        </div>
            ...
            <form action="{{ route('classes.update', $classe) }}" method="POST" class="space-y-6">
                ...
                <div class="form-field">
                    ...
                    <input type="text"
                           ...
                           required>
                    <p class="form-hint">Le nom doit rester unique pour eviter les ambiguites d'inscription.</p>
                    @error('nom_classe')
