...
@section('title', 'Importer des absences')
@section('breadcrumb', 'Evaluations / Absences / Importation')
...
<div class="space-y-6">
    ...
    <section style="background:linear-gradient(135deg,#000000 0%,#009e60 60%,#006400 100%);border-radius:32px;padding:2rem;position:relative;overflow:hidden;box-shadow:0 28px 80px rgba(0,0,0,0.28);">
        ...
        <div>
            ...
            <h2 style="margin-top:10px;font-size:1.7rem;font-weight:700;color:#fff;line-height:1.2;">Importer des heures d'absence depuis un fichier Excel ou CSV</h2>
            <p style="margin-top:8px;font-size:14px;color:rgba(255,255,255,0.72);">Chargez un fichier .xlsx, .xls ou .csv. Choisissez la matiere et le semestre — les heures seront associees aux eleves via leur matricule et une penalite (regle 4.9) sera appliquee sur leur moyenne.</p>
        </div>
    </section>
            ...
            <table style="width:100%;border-collapse:collapse;font-size:12px;max-width:480px;">
                <thead>
                    <tr style="background:rgba(0,158,96,0.07);">
                        ...
                        <th style="padding:8px 16px;text-align:left;border:1px solid rgba(0,158,96,0.15);color:#009e60;font-weight:700;">Colonne B — Heures d'absence <span style="color:#ef4444;">*</span></th>
                    </tr>
                </thead>
                <tbody>
                    <tr style="background:#f8fafc;">
                        <td style="padding:8px 16px;border:1px solid rgba(0,158,96,0.10);color:#64748b;font-style:italic;">Matricule</td>
                        <td style="padding:8px 16px;border:1px solid rgba(0,158,96,0.10);color:#64748b;font-style:italic;">Heures</td>
                    </tr>
                    <tr>
                        <td style="padding:8px 16px;border:1px solid rgba(0,158,96,0.10);color:#0f172a;">ETP001</td>
                        <td style="padding:8px 16px;border:1px solid rgba(0,158,96,0.10);color:#0f172a;">6</td>
                    </tr>
                    <tr>
                        <td style="padding:8px 16px;border:1px solid rgba(0,158,96,0.10);color:#0f172a;">ETP002</td>
                        <td style="padding:8px 16px;border:1px solid rgba(0,158,96,0.10);color:#0f172a;">0</td>
                    </tr>
                </tbody>
            </table>
        </div>
        <p style="margin-top:10px;font-size:12px;color:#64748b;"><i class="bi bi-info-circle" style="color:#009e60;"></i> Une ligne remplace le total d'heures deja enregistre pour cet eleve, cette matiere et ce semestre. Les eleves non inscrits pour l'annee en cours seront ignores.</p>
    </section>
    ...
    <section style="background:#fff;border-radius:24px;border:1px solid rgba(0,158,96,0.18);padding:1.5rem;box-shadow:0 8px 24px rgba(0,0,0,0.06);">
        ...
        <form action="{{ route('absences.import.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div style="display:grid;gap:20px;">
                ...
                <div style="padding:10px 14px;border-radius:12px;background:rgba(0,158,96,0.06);border:1px solid rgba(0,158,96,0.15);">
                    <p style="font-size:12px;color:#009e60;"><i class="bi bi-calendar2-check"></i> Les absences seront enregistrees pour l'annee <strong>{{ $annee->libelle }}</strong>.</p>
                </div>
                @endif
                ...
                <div style="display:flex;gap:10px;flex-wrap:wrap;">
                    ...
                    <a href="{{ route('absences.index') }}" style="display:inline-flex;align-items:center;gap:8px;padding:10px 22px;border-radius:999px;background:rgba(100,116,139,0.10);color:#475569;font-size:13px;font-weight:600;text-decoration:none;border:1px solid rgba(100,116,139,0.20);">
