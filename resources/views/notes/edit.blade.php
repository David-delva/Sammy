...
<div class="mx-auto max-w-4xl space-y-6">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
            ...
            <p class="mt-2 text-sm text-gray-500">Ajustez l'élève, la matière, la valeur ou le type d'évaluation pour cette note.</p>
        </div>
    ...
    <div class="card">
        <div class="card-header">
            <div>
                <h4>Modification</h4>
                <p class="mt-1 text-xs text-gray-400">Mettez à jour les informations de la note sélectionnée.</p>
            </div>
